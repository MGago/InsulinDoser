...
public class ObjectFactory {
    ...
    private final static QName _MealtimeInsulinDose_QNAME = new QName("http://webservice.server/", "mealtimeInsulinDose");
    private final static QName _MealtimeInsulinDoseResponse_QNAME = new QName("http://webservice.server/", "mealtimeInsulinDoseResponse");
    private final static QName _PersonalSensitivityToInsulinResponse_QNAME = new QName("http://webservice.server/", "personalSensitivityToInsulinResponse");
    private final static QName _BackgroundInsulinDose_QNAME = new QName("http://webservice.server/", "backgroundInsulinDose");
    private final static QName _BackgroundInsulinDoseResponse_QNAME = new QName("http://webservice.server/", "backgroundInsulinDoseResponse");
    private final static QName _PersonalSensitivityToInsulin_QNAME = new QName("http://webservice.server/", "personalSensitivityToInsulin");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ws9
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.server/", name = "mealtimeInsulinDose")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.server/", name = "mealtimeInsulinDoseResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.server/", name = "personalSensitivityToInsulinResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.server/", name = "backgroundInsulinDose")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.server/", name = "backgroundInsulinDoseResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.server/", name = "personalSensitivityToInsulin")
