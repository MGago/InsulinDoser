 ...
 * 
 */
@WebServiceClient(name = "InsulinDoseCalculatorService", targetNamespace = "http://server/", wsdlLocation = "http://qcs05.dei.uc.pt:8080/insulin?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://qcs05.dei.uc.pt:8080/insulin?wsdl");
