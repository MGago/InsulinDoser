...
public class WebService4 extends WebService {

    private final String url = "http://qcs12.dei.uc.pt:8080/insulin?wsdl";

    ws4.InsulinDoseCalculatorService service = new ws4.InsulinDoseCalculatorService();
    ws4.InsulinDoseCalculator port = service.getInsulinDoseCalculatorPort();
    ...
    public int personalInsulinSensitivity(int m1, int m2, int m3, int m4, int m5, List m6, List m7) {
        ...
        System.out.println("WS4: personalInsulinSensitivity: dose = "+dose);
        return dose;
    }
